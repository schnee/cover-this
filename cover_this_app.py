...
st.text("This app will generate a cover letter based on a PDF resume and a job spec in a text file. Simply upload both press the 'Generate' button.")
st.link_button("Buy me a coffee", "https://www.buymeacoffee.com/mahkr")
